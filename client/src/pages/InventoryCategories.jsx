...
export default function InventoryCategories() {
  ...
  const { data, isLoading: loading } = useQuery({
    ...
    queryFn: () => getCategories({ page, search: debouncedSearch, ordering }),
  ...
  const saveMutator = useMutation({
    ...
    onMutate: async (newCategory) => {
      ...
      const previous = queryClient.getQueryData(
          ['inventoryCategories', page, debouncedSearch, ordering]
      )
          ...
          <main className="flex-1 p-6 md:p-8 md:ml-64 w-full transition-all duration-300">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-500 text-sm mt-2">
                Organize inventory items by logical categories.
              </p>
            </div>
