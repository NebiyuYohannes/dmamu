...
class OTPCode(models.Model):
    ...
    attempts = models.PositiveIntegerField(default=0)  # Added for max attempts security
...
class User(AbstractUser):
    ...
    verification_method = models.CharField(max_length=10, choices=VERIFICATION_CHOICES, default=VERIFICATION_EMAIL)
